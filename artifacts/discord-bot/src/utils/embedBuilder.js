...
// ── EMOJI map — all using emoji.gg custom emojis ──────────────────────────────
export const EMOJI = {
  // ── Security & Shields ─────────────────────────────────────────────────────
  ...
  // ── Static strings for nav/UI (always unicode — needed in button emojis) ────
  arrow:         '╰',
  arrowRight:    '➜',
  dot:           '◆',
  bullet:        '▸',
...
export function createEmbed(options = {}) {
  ...
  embed.setFooter(
    footer
      ...
      : { text: `${EMOJI.sparkle} Lilith Protector  •  Premium Protection` }
  );
